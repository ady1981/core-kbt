...
Для того чтобы LLM способности использовать **требуется** использовать особую архитектуру, в как можно более простом виде. **Архитектуры такого типа нет в существующих LLM фреймворках**. Поэтому, цель core-kbt - предоставить такой "правильный" инструмент (настраиваемый компонент), с "правильной" архитектурой.
Основные задачи:
* выявление требований для общецелевого программирования с точки зрения архитектуры и внедрение элементов этой архитектуры
