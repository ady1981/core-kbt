...
* если JSON-схемы для YAML/JSON-сущностей недостаточно: для углубления знания для решения задачи нужна последовательная разработка доменной онтологии для этой задачи
