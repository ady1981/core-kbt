...
Мини-фреймворк core-kbt (KBT = Knowledge Base Trajectory) создан для упрощения разработки LLM-based приложений, для разработки и оптимизации баз знаний. 
...
- логико-аспектный подход к LLM-промпту.
...
- пример решения задачи обоснованного выбора лучшего из двух вариантов (см. ИИ-функцию [concept_aspect_comparison](kbt-core%2Fai_function_impl%2Fconcept_aspect_comparison.py)) и пример интеграции с n8n.

### Краткое введение

Цель проекта состоит в создании инструментов для разработки надежных LLM-based приложений, нацеленных на разработку и оптимизацию баз знаний, которыми будут пользоваться люди и другие интеллектуальные приложения.
Основная задачи:
...
- с LLM нужно взаимодействовать на естественном языке и нет эталона как нужно делать правильно
...
- возможности LLM дают работать со знаниями и нужно научится как это правильно делать
...
- сделан пример интеграции с n8n.
