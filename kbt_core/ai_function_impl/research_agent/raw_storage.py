...
def write_document(topic_keyword: str, site_context_url: str, version: str,  content_id: str, content: str) -> str:
    ...
    """
    raw_dir = Path(f"raw/{topic_keyword}/{site_context_url}/{version}")
